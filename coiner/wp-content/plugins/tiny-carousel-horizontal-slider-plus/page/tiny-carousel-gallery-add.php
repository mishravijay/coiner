...
if ($tchsp_error_found == FALSE && strlen($tchsp_success) > 0)
{
	...
	<div class="updated fade">
		<p><strong><?php echo $tchsp_success; ?> <a href="<?php echo TCHSP_ADMINURL1; ?>"><?php _e('Click here', TCHSP_TDOMAIN); ?></a> 
...
<div class="form-wrap">
	...
	<form name="tchsp_form" method="post" action="#" onsubmit="return _tchsp_gal_submit()"  >
      <h3><?php _e('Add Gallery Details', TCHSP_TDOMAIN); ?></h3>
		...
		<p><?php _e('Enter your image width, You should add same width images in this gallery. (Ex: 200)', TCHSP_TDOMAIN); ?></p>			
		
		<label for="tag-a"><?php _e('Height', TCHSP_TDOMAIN); ?></label>
		<input name="gal_height" type="text" id="gal_height" value="" maxlength="4" />
		<p><?php _e('Enter your image height, You should add same height images in this gallery. (Ex: 150)', TCHSP_TDOMAIN); ?></p>
      ...
      <p class="submit">
        ...
        <input name="publish" lang="publish" class="button" onclick="_tchsp_gal_redirect()" value="<?php _e('Cancel', TCHSP_TDOMAIN); ?>" type="button" />
