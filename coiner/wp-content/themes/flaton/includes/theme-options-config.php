...
*/
        ...
        public function setArguments() {
            ...
            if (!isset($this->args['global_variable']) || $this->args['global_variable'] !== false) {
                ...
                $this->args['intro_text'] = sprintf(__('<p class="btn-upgrade"><a href="http://www.webulousthemes.com/?add-to-cart=23"><i class="fa fa-upload"></i> Upgrade for just $39</a> <a href="http://demo.webulous.in/flaton" class="vide-demo"><i class="fa fa-eye"></i>View Demo</p>', 'flaton'), $v);
            } else {
